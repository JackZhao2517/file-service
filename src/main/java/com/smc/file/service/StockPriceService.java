...
public class StockPriceService {
	...
	public CommonResult deleteStockByCompanyCode(String companyCode) {
		try {
			stockPriceRepository.deleteStockByCompanyCode(companyCode);
			return CommonResult.build(200, "deleteCompany success!");
		} catch (Exception e) {
//			logger.error("Fail to deleteCompanyById data:", e);
			return CommonResult.build(2, "DB ERROR!");
		}
	}
