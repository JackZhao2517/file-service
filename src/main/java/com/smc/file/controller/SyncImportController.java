...
public class SyncImportController {
	...
	public CommonResult deleteCompanyByCode(@RequestBody StockPriceEntity stockPrice) {
		return stockPriceService.deleteStockByCompanyCode(stockPrice.getCompanyCode());
	}
